...
public class Discovery {
	...
	public Discovery(Discovery discovery){
		...
		setDescription(discovery.getDescription());
		setUrl(discovery.getUrl());
		setTimestamp(new Timestamp(discovery.getTimestamp().getTime()));
		setUser(new User (discovery.getUser()));
		setUpVote(discovery.getUpVote());
		setDownVote(discovery.getDownVote());
