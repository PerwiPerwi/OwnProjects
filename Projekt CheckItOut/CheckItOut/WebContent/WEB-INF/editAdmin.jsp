...
<link href="${pageContext.request.contextPath}/resources/css/edit.css"
	type="text/css" rel="stylesheet">
	<link href="${pageContext.request.contextPath}/resources/css/editProfile.css"
	type="text/css" rel="stylesheet">
</head>
<body>
	...
	<form action="update" method="POST">
		<div class="form">
		<h1>Hi <c:out value="${sessionScope.user.username}"></c:out>!</h1>
		...
		<a class="changePhoto" href="pictureWriterView">Change Photo </a>
		</div>
				</div>
	<form action="update" method="POST">
		<!-- edit form column -->
		<div class="col-md-9 personal-info">
			...
			<form class="form-horizontal" role="form">
					...
					<div class="field-wrap">
						<input id="inputEmail" placeholder="Email" name="inputEmail" type="email"
				...
				<button type="reset" class="button button-default" />
				RESET
				</button>
				<h3 class="delete">
					<a class="deleteAcc" href="delete?user_id=${user.id}">DELETE ACCOUNT</a>
				</h3>
			</form>
		</div>
		</div>
