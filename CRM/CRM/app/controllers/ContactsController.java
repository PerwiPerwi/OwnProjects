...
import views.html.editContactForm;
...
public class ContactsController extends Controller {
    ...
    public Result addContact() {
        ...
        if (contactForm.hasErrors()) {
            return badRequest(editContactForm.render(contactForm,"Check Your Contact Form!"));
        }
    ...
    public Result editContactForm(long contactId) {
        ...
        return ok(editContactForm.render(contactForm, null));
    }
